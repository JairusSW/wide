...
import (
	...
	wideregister "github.com/JairusSW/wide/register"
...
func TestManifestMatchesCatalogMetadata(t *testing.T) {
	...
	providers := wideregister.Providers()
	if len(providers) != 1 {
	...
	assertProviderCatalogCurrent(t, "github.com/JairusSW/wide/register", providers)
}
